            ...
            <div class="col-lg-12">
                <div class="collapse navbar-collapse main-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a href="#" role="button" class="dropdown-toggle" data-hover="dropdown"> <i class="glyphicon glyphicon-user"></i>     欢迎您，${sessionScope.username} <i class="caret"></i></a>
    ...
    <div class="row">
        ...
        <div class="col-md-2 bootstrap-admin-col-left">
            <ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
                ...
                <li>
                    <a href="user_complaininfo"><i class="glyphicon glyphicon-chevron-right"></i> 工单历史记录</a>
                </li>
                <li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default bootstrap-admin-no-table-panel">
                        <div class="panel-heading">
                            <div class="text-muted bootstrap-admin-box-title">公告信息</div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                        ...
                        <c:forEach var="annoUserList" items="${announceUserList}">
                            <tbody>
                            <td>${annoUserList.title}</td>
                            <td>${annoUserList.content}</td>
                            <td>${annoUserList.announcetime}</td>
                            </tbody>
                        </c:forEach>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="url" value="user_history">
                    <div class="form-group">
