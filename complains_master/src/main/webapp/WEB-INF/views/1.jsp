...
<div class="am-g tpl-g">
    ...
    <div class="tpl-login">
        <div class="tpl-login-content">
            ...
            <form class="am-form tpl-form-line-form" method="post" action="/DenggLib/register">
                ...
                <div class="am-form-group">
                    <input type="text" class="tpl-form-input" id="user-name" name="code" required="required" placeholder="请输入验证码">
                </div>
                <img src="${pageContext.request.contextPath}/generateimg" style="position:relative; left: 2px;margin-bottom: 15px"/> <a href="" style="color:#999;">看不清，换一张</a>
