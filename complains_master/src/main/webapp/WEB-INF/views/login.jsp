...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            ...
            <form class="bootstrap-admin-login-form" method="post" action="${pageContext.request.contextPath}/login">
...
<%--                <label class="control-label" for="password">没有账号请<a href="#{pageContext.request.contextPath}/admin" style="color:blue;">注册</a></label>--%>
                <br>
