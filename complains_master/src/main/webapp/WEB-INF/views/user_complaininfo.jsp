    ...
    <div class="row">
        ...
        <div class="col-md-10">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default bootstrap-admin-no-table-panel">
                        <div class="panel-heading">
                            <div class="text-muted bootstrap-admin-box-title">工单历史信息</div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                        ...
                        <c:forEach var="history" items="${complainHisList}">
                            <tbody>
                            ...
                            <td>${history.tel}</td>
                            <td>
                                <c:if test="${history.status ==0}">未处理</c:if>
                                <c:if test="${history.status ==1}">处理中</c:if>
                                <c:if test="${history.status ==2}">已完成</c:if>
                            </td>
                            <td>${history.type}</td>
                            <td>${history.content}</td>
                            <td>
                                <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" onclick="deleteHis(${history.cid})">删除</button>
                            </td>
                            </tbody>
                        </c:forEach>
                    </table>
            ...
            <script type="text/javascript">
                function deleteHis(cid) {
                    con=confirm("是否删除?");
                    if(con==true){
                        location.href = "${pageContext.request.contextPath}/deleteUserHisComplain?cid="+cid;
                    }
                }
            </script>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="url" value="user_borrow">
                    <div class="form-group">
